        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="lg:w-2/5 flex flex-col gap-6">
            <div className="flex flex-col gap-2">
                <h3 className="text-sm font-medium text-text-secondary">Original Prompt</h3>
            ...
            <div className="flex flex-col gap-2">
                  <h3 className="text-sm font-medium flex items-center gap-1.5">
                      ...
                      <span className="flow-text-gradient text-transparent font-serif-magic italic text-base">Prompt Magic</span>
                  </h3>
            ...
            <div className="flex flex-col gap-4 pt-6 border-t border-text-secondary/20 items-center">
              <p className="font-semibold text-lg text-text-primary">Edit with <span className="font-serif-magic italic flow-text-gradient">Prompt Magic</span></p>

              <button type="button" onClick={handleMicClick} className="h-20 w-20 flex items-center justify-center flow-gradient-background rounded-full text-white shadow-glow hover:opacity-90 transition-all duration-300 hover:scale-105" aria-label={isRecording ? 'Stop recording edit' : 'Start recording edit'}>
                  <MicrophoneIcon className="w-8 h-8" />
              </button>
              <p className="text-text-secondary mt-2 text-sm">Tap to speak your edits</p>
              ...
              <div className="mt-4 text-center">
                  <button onClick={() => setShowAdvancedEdit(!showAdvancedEdit)} className="text-sm text-text-secondary hover:text-text-primary transition-colors">
                      {showAdvancedEdit ? 'Hide Advanced Settings' : 'Advanced Settings'}
                  </button>
              </div>
                          ...
                          <div className="bg-surface rounded-2xl p-4 flex flex-col gap-3">
                              ...
                              ></textarea>
                               <div className="flex items-end justify-between mt-2">
                                  ...
                                  <button type="submit" className="h-10 w-10 flex items-center justify-center flow-gradient-background rounded-full text-white shadow-lg hover:opacity-90 transition-opacity" aria-label="Submit edits">
