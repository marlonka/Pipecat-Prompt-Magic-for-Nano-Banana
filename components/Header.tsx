            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    <div className="flex items-center gap-3">
                         <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-primary to-google-green flex items-center justify-center flex-shrink-0">
                            <LogoIcon className="w-5 h-5 text-white" />
                         </div>
                        <h1 className="text-md font-bold tracking-tight text-text-primary hidden sm:block">
                           <span className="font-serif-magic italic text-lg flow-text-gradient">Prompt Magic</span> for Nano Banana
                        </h1>
                    </div>
