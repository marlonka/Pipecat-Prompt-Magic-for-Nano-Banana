    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center h-full p-4">
          <div className="w-full max-w-2xl flex-grow flex flex-col justify-center items-center">
              <div className="text-center mb-8">
                  <h1 className="text-[2.1rem] leading-tight sm:text-5xl font-bold tracking-tighter">
                      Hello! Want to see some<br />
                      Nano Banana <span className="font-serif-magic italic text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-green-400 pr-2 -mr-2">Prompt Magic?</span>
                  </h1>
              </div>
              
              <button type="button" onClick={handleMicClick} className="h-24 w-24 flex items-center justify-center flow-gradient-background rounded-full text-white shadow-glow hover:opacity-90 transition-all duration-300 hover:scale-105" aria-label={isRecording ? 'Stop recording' : 'Start recording'}>
                  <MicrophoneIcon className="w-10 h-10" />
              </button>
              <p className="text-text-secondary mt-4">{hasImages ? 'Tap to describe your edits' : 'Tap to speak your idea'}</p>
                        ...
                        <div className="bg-surface rounded-2xl p-4 flex flex-col gap-3">
                          ...
                          ></textarea>
                           <div className="flex items-end justify-between mt-2">
                               ...
                               <button type="submit" className="h-10 w-10 flex items-center justify-center flow-gradient-background rounded-full text-white shadow-lg hover:opacity-90 transition-opacity" aria-label="Submit prompt">
          ...
          <footer className="text-center py-4">
              <p className="text-xs text-text-secondary">Made by Marlon Kaulich</p>
          </footer>
      </div>
    </>
  );
